                      ...
                      <div class="card-header">
                          ...
                          <form action="index.php" method="GET">
                            ...
                            <div class="mb-3 radio-group">
                              ...
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="radiocheck" id="radioTempat" value="tempat_lahir" autocomplete="off">
                          ...
                          <!-- END Form -->
                          <div class="mb-3">
                              <a class="btn btn-primary" href="index.php">Refresh</a>
                          </div>
                      </div>
                      <div class="card-body">
                          <!-- Table  -->
